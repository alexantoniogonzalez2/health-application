class PrePrestadores < ActiveRecord::Base
  ...
  has_many :boletas, :class_name => 'PreBoletas', :foreign_key => 'prestador_id'
  ...
  def getTelefono
	...
	private
  def app_params
    params.require(:list).permit(:id,:interconsultas,:nombre,:rut,:es_centinela,:prestador_profesionales,:prestador_administrativos,:prestadores_direcciones,:prestadores_telefonos,:persona_prestaciones,:boletas,:regla_pagos)
  end	
