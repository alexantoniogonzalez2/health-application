class PrePrestadores < ActiveRecord::Base
  ...
  def getTelefono
	...
	private
  def app_params
    params.require(:list).permit(:id,:interconsultas,:nombre,:rut,:es_centinela,:prestador_profesionales,:prestador_administrativos,:prestadores_direcciones,:prestadores_telefonos,:persona_prestaciones,:regla_pagos)
  end	
